...
import { Camera, RotateCcw, Slash as Flash, FlashlightOff as FlashOff, Image, X, Download } from 'lucide-react-native';
    ...
    return (
      ...
      >
        <SafeAreaView style={styles.permissionContainer}>
          <Animated.View entering={FadeInUp.delay(100)} style={styles.permissionContent}>
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <SafeAreaView style={styles.topControls}>
          <Animated.View entering={SlideInLeft.delay(100)} style={styles.topControlsContainer}>
            ...
            <View style={styles.processingIndicator}>
              {isProcessing && (
                <Animated.View entering={FadeInDown} style={styles.processingBadge}>
        ...
        {/* Bottom Controls */}
        <Animated.View entering={FadeInUp.delay(200)} style={styles.bottomControls}>
